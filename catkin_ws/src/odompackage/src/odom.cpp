...
private:
	...
	void leftencoderCb(const std_msgs::Bool::ConstPtr& left_ticks);

	void rightencoderCb(const std_msgs::Bool::ConstPtr& right_ticks);
...
void Odometry_calc::leftencoderCb(const std_msgs::Bool::ConstPtr& left_ticks)
...
void Odometry_calc::rightencoderCb(const std_msgs::Bool::ConstPtr& right_ticks)
